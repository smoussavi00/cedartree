...
function requirements(){
  ...
  if(passw.value.length >= 8) req2.style.backgroundColor = '#d6d5cd';
  else req2.style.backgroundColor = '#121211';
  
  if(/[a-z]/.test(passw.value)) req3.style.backgroundColor = '#d6d5cd';
  else req3.style.backgroundColor = '#121211';

  if(/\d/.test(passw.value)) req4.style.backgroundColor = '#d6d5cd';
  else req4.style.backgroundColor = '#121211';

}

function matching(){
  if(passw.value == passwconf.value && passw.value) req5.style.backgroundColor = '#d6d5cd';
  else req5.style.backgroundColor = '#121211';
}